...
const Navbar = () => {
  ...
  return (
    <nav className="w-full bg-white pt-[14px] pb-[14px] third-nav">
      <div className="max-w-screen-xl mx-auto flex items-center  px-4 lg:px-0 ml-3 sticky left-[420] ">
        <div className="hidden md:flex gap-8 ml-3">
          <Link href="/" className="text-[#007580] text-[14px] font-medium">
            Home
          </Link>
          <Link href={"#not-found"} className="text-[14px] font-medium">
            Shop
          </Link>
