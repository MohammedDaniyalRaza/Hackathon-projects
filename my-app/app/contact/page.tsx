        ...
        <div className="bg-white p-8 w-full sm:w-[635px]">
          <form action="#" method="POST">
            ...
            <div>
              <button
                type="submit"
                className="w-full sm:w-[237px] h-[55px] bg-[#029FAE] hover:text-[#029FAE] hover:bg-white border shopnow-transition border-manual border-[#B88E2F] rounded-[5px] text-white py-3"
              >
                Submit
              </button>
            </div>
